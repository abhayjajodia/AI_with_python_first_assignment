...
# 4. Try different alpha values for Ridge and Lasso
alphas = [0.01, 0.1, 1, 10, 100]  # simpler than logspace
ridge_scores = []
lasso_scores = []
...
# 7. Fit best models and show coefficients
scaler = StandardScaler()
X_train_scaled = scaler.fit_transform(X_train)
X_test_scaled = scaler.transform(X_test)
